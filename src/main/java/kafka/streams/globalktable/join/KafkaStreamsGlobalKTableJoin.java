...
public class KafkaStreamsGlobalKTableJoin {
	...
	final static String  userOccupationStateStore = "all-region-top-exports";
	...
	public static class KStreamToTableJoinApplication {
		...
		public KStream<String, Long> process(@Input("input") KStream<String, Long> userClicksStream,
											 ...
											 @Input("inputTable2") KTable<String, String> regionTopExportsTable
											 ) {
			...
			return userClicksStream
					...
					.transform(() -> new UserTransformer(userOccupationStateStore), userOccupationStateStore)
